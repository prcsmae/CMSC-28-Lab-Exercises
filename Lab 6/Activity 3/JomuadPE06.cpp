...
int main() {
  ...
  Person director;
  string fn, ln, gender;
  // Do-while loop that asks for information for the attributes in the class
  // Person
  do {
    cout << "\nEnter first name: ";
    getline(cin, fn);
  ...
  cout << "\nMOVIE DETAILS\n\n";
  // Calling the getTitle(), getSynopsis(), and getRating() method from class
  // Movie
  ...
  cout << "Genre(s):\n";
  // Creates a list data type to store the list that is returned by the
  // getGenre() method
